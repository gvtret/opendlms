...
static const db_ic_object_descr demand_descr = {
    .attributes   = demand_attrs,
    .methods      = demand_methods,
    .class_id     = 5,
    .obis         = { 0, 0, 0, 0, 0, 0 },
    .attr_count   = 7,
    .method_count = 2,
...
static uint8_t demand_axdr_fixed_size(uint8_t tag)
{
    ...
    case DEMAND_TAG_FLOAT32:  return 4U;
    case DEMAND_TAG_FLOAT64:  return 8U;
    default:                  return 0U;
    }
}
...
static csm_db_code demand_dispatch(db_ic_inst_t *inst, db_ic_op_t op,
...
static const db_ic_class ic_demand_class = {
    .class_id  = 5,
    .name      = "Demand Register",
    .version   = 0,
    .create    = demand_create,
    .dispatch  = demand_dispatch
};
