...
csm_db_code db_ic_default_get_attr(const db_ic_inst_t *inst, uint8_t attr_id, uint8_t *buf, uint8_t buf_size, csm_array *out) {
	(void)inst;
	(void)attr_id;
...
csm_db_code db_ic_default_set_attr(db_ic_inst_t *inst, uint8_t attr_id, const uint8_t *buf, uint8_t buf_size, csm_array *in) {
	(void)inst;
	(void)attr_id;
	(void)buf;
	(void)buf_size;
...
csm_db_code db_ic_default_action(db_ic_inst_t *inst, uint8_t method_id, csm_array *in, csm_array *out) {
	(void)inst;
	(void)method_id;
	(void)in;
	(void)out;
