...
static uint8_t reg_axdr_fixed_size(uint8_t tag)
{
    ...
    case REG_TAG_FLOAT32:     return 4U;
    case REG_TAG_FLOAT64:     return 8U;
    default:                  return 0U;
    }
}
...
static csm_db_code reg_dispatch(db_ic_inst_t *inst, db_ic_op_t op,
...
static const db_ic_class ic_register_class = {
    .class_id  = 3,
    .name      = "Register",
    .version   = 0,
    .create    = reg_create,
