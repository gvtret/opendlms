#!/usr/bin/env python3
"""Final attempt: use the old C constants, no L in round (L already baked into C), with correct algorithm structure."""
...
C_raw = (
    ...
    "66e3ee31525f38674e7550d18be3f6a2ca15541977addfeb67a01824a05f9cea88bd2c1535b4b559ade8a23fe9eaa911f46ce3598621cc421085206ebd52d2c6"
    ...
    "ee31525f382b816550d18be3f6d8005f541977addf77c4ff1824a05f9ca730e02c1535b4b5b65507a23fe9eaa9c09038e3598621ccf05db4206ebd52d2dad74f"
...
assert len(C_raw) == 12 * 128, f"Expected {12*128} hex chars, got {len(C_raw)}"
C = [bytes.fromhex(C_raw[i*128:(i+1)*128]) for i in range(12)]
