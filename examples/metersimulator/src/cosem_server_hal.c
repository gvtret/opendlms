...
static const cfg_cosem cDefaultSap[] = {
    {
     1U,                 {0x00U, 0x01U, 0x02U, 0x03U, 0x04U, 0x05U, 0x06U, 0x07U, 0x08U, 0x09U, 0x0AU, 0x0BU, 0x0CU, 0x0DU, 0x0EU, 0x0FU},
     ...
     CSM_AUTH_LOW_LEVEL,                                                                                                    0U,
     },
    {
     16U,                  {0x00U, 0x01U, 0x02U, 0x03U, 0x04U, 0x05U, 0x06U, 0x07U, 0x08U, 0x09U, 0x0AU, 0x0BU, 0x0CU, 0x0DU, 0x0EU, 0x0FU},
     {0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU},
     {0xD0U, 0xD1U, 0xD2U, 0xD3U, 0xD4U, 0xD5U, 0xD6U, 0xD7U, 0xD8U, 0xD9U, 0xDAU, 0xDBU, 0xDCU, 0xDDU, 0xDEU, 0xDFU},
     {0x30U, 0x30U, 0x30U, 0x30U, 0x30U, 0x30U, 0x30U, 0x31U},
     CSM_AUTH_LOW_LEVEL,      0U,
    ...
    {
     48U, {0x00U, 0x01U, 0x02U, 0x03U, 0x04U, 0x05U, 0x06U, 0x07U, 0x08U, 0x09U, 0x0AU, 0x0BU, 0x0CU, 0x0DU, 0x0EU, 0x0FU},
     {0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU},
     {0xD0U, 0xD1U, 0xD2U, 0xD3U, 0xD4U, 0xD5U, 0xD6U, 0xD7U, 0xD8U, 0xD9U, 0xDAU, 0xDBU, 0xDCU, 0xDDU, 0xDEU, 0xDFU},
     {0x30U, 0x30U, 0x30U, 0x30U, 0x30U, 0x30U, 0x30U, 0x31U},
     CSM_AUTH_HIGH_LEVEL_GMAC, 1U,
     }
};
...
static uint8_t gIc_initialized[256][2];

uint32_t csm_sys_get_ic(uint8_t sap, csm_sec_ic ic) {
	uint8_t dir = (ic == CSM_SEC_IC_SERVER) ? 1U : 0U;

	if (gIc_initialized[sap][dir] == 0U) {
		gIc[sap][dir] = 0x01234567U;
		gIc_initialized[sap][dir] = 1U;
	}

	uint32_t value = gIc[sap][dir];
	gIc[sap][dir]++;
	return value;
}
...
int csm_sys_gcm_update(uint8_t channel, const uint8_t *plain, uint32_t plain_len, uint8_t *crypt) {
	if ((channel >= NUMBER_OF_CHANNELS) || (chan_ctx_active[channel] == 0U) || ((plain_len > 0U) && ((plain == NULL) || (crypt == NULL)))) {
		return FALSE;
	}
